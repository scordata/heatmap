	...
	fshm.locationPageSuccess = function (position) {
		...
		var lat = 40.743648;//position.coords.latitude;
		var	lng = -73.989193;//position.coords.longitude;
	...
	fshm.venueInfoOutput = function (venue) {
		...
		return  venue.name + "<br />" +  venue.location.address +  "<br />People Here: " + venue.hereNow.count + "<br><a target='_blank' href='" + venue.canonicalUrl + "'>FourSquare</a>";
	}
	$(function () {
		"use strict";
		var $search = $('#search'),
